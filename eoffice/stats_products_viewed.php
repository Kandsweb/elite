          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent" align="center"><?php echo TABLE_HEADING_VIEWED; ?>&nbsp;(Actual)</td>
              </tr>
<?php
...
// only show low stock on products that can be added to the cart
    if ($zc_products->get_allow_add_to_cart($products->fields['products_id']) == 'Y') {
      ...
      $offset = get_viewed_offset($products->fields['products_id']);
      $actual_viewed = $products->fields['products_viewed'] - $offset;
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='<?php echo zen_href_link(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&pID=' . $products->fields['products_id']); ?>'">
                ...
                <td class="dataTableContent" align="center"><?php echo $products->fields['products_viewed']; ?>&nbsp;
                <?php if($actual_viewed != $products->fields['products_viewed']) echo '(' . $actual_viewed . ')'?></td>
              </tr>
<?php
    }
    $products->MoveNext();
