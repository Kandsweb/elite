...
class qqFileUploader {
     ...
     var $sizeLimit = null;
    var $inputName = 'qqfile';
    var $chunksFolder = 'chunks';

    var $chunksCleanupProbability = 0.001; // Once in 1000 requests on avg
    var $chunksExpireIn = 604800; // One week
     ...
     */
     function handleUpload($uploadDirectory, $name = null){
        ...
        if ((!is_writable($uploadDirectory) || !is_executable($uploadDirectory))&& !($_SERVER['HTTP_HOST']=='localhost')){
            return array('error' => "Server error. Uploads($uploadDirectory) directory isn't writable or executable.");
        }
