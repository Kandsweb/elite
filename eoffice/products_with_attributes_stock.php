...
break;
    ...
    echo '<form method="get" action="products_with_attributes_stock_ajax.php" id="pwas-search" name="pwas-search">Search:  <input id="pwas-filter" type="text" name="search"/><input type="submit" value="Search" id="pwas-search" name="pwas-search"/></form><span style="margin-right:10px;">&nbsp;</span>';
    echo '<form method="get" action="products_with_attributes_stock.php" id="pwas-search" name="pwas-search"><input id="pwas-filter" type="hidden" name="search" value="all"/><input type="submit" value="View All"/></form>';
    //echo '<form method="post" action="products_with_attributes_stock_ajax.php?save=1" id="store" name="store"><input type="submit" value="store" id="store" name="store"/> <span style=font-weight:bold;">Keyword: all to restore</span>';
