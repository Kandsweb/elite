...
define('EASYPOPULATE_DISPLAY_RESULT_DELETE_NOT_FOUND','<br /><font size="2px" color="darkviolet"><b>NOT FOUND! - Model:</b> %s - cant delete...</font>');
define('EASYPOPULATE_DISPLAY_RESULT_CATEGORY_NOT_FOUND', '<br /><font size="2px" color="red"><b>SKIPPED! - Model:</b> %s - No category provided for this%s product</font>');
define('EASYPOPULATE_DISPLAY_RESULT_CATEGORY_NAME_LONG','<br /><font size="2px" color="red"><b>SKIPPED! - Model:</b> %s - Category name(s) too long (max. %s)</font>');
define('EASYPOPULATE_DISPLAY_RESULT_MODEL_NAME_LONG','<br /><font size="2px" color="red"><b>SKIPPED! - Model: </b>%s - model name too long</font>');
define('EASYPOPULATE_DISPLAY_RESULT_NEW_PRODUCT', '<br /><font color="green"><b>NEW PRODUCT! - Model:</b> %s</font> | ');
define('EASYPOPULATE_DISPLAY_RESULT_NEW_PRODUCT_FAIL', '<br /><font size="2px" color="red"><b>ADD NEW PRODUCT FAILED! - Model:</b> %s - SQL error. Check Easy Populate error log in uploads directory</font>');
define('EASYPOPULATE_DISPLAY_RESULT_UPDATE_PRODUCT', '<br /><font color="mediumblue"><b>UPDATED! - Model:</b> %s</font> | ');
define('EASYPOPULATE_DISPLAY_RESULT_UPDATE_PRODUCT_FAIL', '<br /><font size="2px" color="red"><b>UPDATE PRODUCT FAILED! - Model:</b> %s - SQL error. Check Easy Populate error log in uploads directory</font>');
define('EASYPOPULATE_DISPLAY_RESULT_NO_MODEL', '<br /><font size="2px" color="red"><b>No model field in record. This line was not imported</b></font>');
define('EASYPOPULATE_DISPLAY_RESULT_UPLOAD_COMPLETE','<br /><b>Upload Complete</b></p>'); // close paragraph above
define('EASYPOPULATE_DISPLAY_INVALID_IMAGENAME', '<br /><font size="2px" color="red"><b>Model %s image name %s has invalid chars. Renamed to %s</b></font>');
define('EASYPOPULATE_DISPLAY_RESULT_NO_MANUFACTURE', '<br /><font size="1px" color="Orange"><b>No Manufacture %s (Import OK)</b></font>');
