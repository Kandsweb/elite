...
// email disclaimer
  ...
  define('EMAIL_SPAM_DISCLAIMER','This email is sent in accordance with the UK (EU) anti-spam legislation 2003. Removal requests can be sent to this address and will be honored and respected.');
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">'.STORE_NAME.'</a>. Design by <a href="http://www.kandsweb.co.uk" target="_blank">KandS</a>');
