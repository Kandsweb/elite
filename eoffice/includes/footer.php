...
<table border="0" width="100%" cellspacing="10" cellpadding="10">
  <tr>
    <td align="center" class="smallText" height="100" valign="bottom">E-Commerce Engine Copyright &copy; 2007-<?php echo date('Y'); ?> <a href="http://www.kandsweb.co.uk" target="_blank">KandS&copy;</a><br /><?php //echo '<a href="' . zen_href_link(FILENAME_SERVER_INFO) . '">' . $current_sinfo . '</a>'; ?></td>
  </tr>
</table>
