<?php
    ...
    */
    ...
    <tr>
      ...
      <th class="thProdImage">'.PWA_PRODUCT_IMAGE.'</th>
      ...
      ';
        ...
        while(!$products->EOF){
            ...
            $html .= '<td class="tdProdImage">'.zen_info_image($products->fields['products_image'], $products->fields['products_name'], "60", "60").'</td>';
