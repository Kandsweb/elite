...
if (!defined('IS_ADMIN_FLAG')) {
  ...
  $za_contents[] = array('text' => 'Excel Populate', 'link' => zen_href_link(FILENAME_EASYPOPULATE, '', 'NONSSL'));
  $za_contents[] = array('text' => 'Adjust Popularity', 'link' => zen_href_link('adjust_popularity.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Filter Options', 'link' => zen_href_link('kas_option_filters_values.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Family Captions', 'link' => zen_href_link('family_captions.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Image Renamer', 'link' => zen_href_link('image_renamer.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Promotions', 'link' => zen_href_link('promotions.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Events', 'link' => zen_href_link('events.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Slideshow Images', 'link' => zen_href_link('slideshow_images.php', '', 'NONSSL'));
  $za_contents[] = array('text' => 'Orphan Images', 'link' => zen_href_link('orphan_image.php', '', 'NONSSL'));
