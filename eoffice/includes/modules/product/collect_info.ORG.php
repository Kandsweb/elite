  ...
  die('Illegal Access');
    ...
    if (isset($_GET['pID']) && empty($_POST)) {
      $product = $db->Execute("select pd.products_name, pd.products_description, pd.products_url,
                                      ...
                                      pdex.product_safety_class, pdex.product_materials, pdex.product_voltage, pdex.product_guarantee, pdex.product_shade_inc,
                                      pdex.product_transformer, pdex.product_driver, pdex.product_cut_out, pdex.product_recess, pdex.product_surface_temp,
                                      pdex.product_cable, pdex.product_application, pdex.product_weight_limit, pdex.product_tilt
...
?>
          ...
          <tr>
            ...
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_model', htmlspecialchars(stripslashes($pInfo->products_model), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_model')); ?>
            <?php
