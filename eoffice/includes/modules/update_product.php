...
if ($_POST['image_delete'] == 1) {
    ...
    if($_POST['bulbs_included']==9)$_POST['bulbs_included']='';
    if($_POST['product_shade_inc']==9)$_POST['product_shade_inc']='';
    if($_POST['product_transformer']==9)$_POST['product_transformer']='';
    if($_POST['product_driver']==9)$_POST['product_driver']='';

      $sql_data_array = array('manufactures_code' => zen_db_prepare_input($_POST['products_manufacture_code']),
                              'ip_rating' => zen_db_prepare_input($_POST['products_ip_rating']),
                              'bulbs_cap' => zen_db_prepare_input($_POST['products_bulbs_cap']),
                              'bulbs_type' => zen_db_prepare_input($_POST['products_bulbs_type']),
                              'bulbs_qty' => zen_db_prepare_input($_POST['products_bulbs_qty']),
                              'bulbs_watts' => zen_db_prepare_input($_POST['products_bulbs_watts']),
                              'dimensions_height' => zen_db_prepare_input($_POST['products_dimensions_height']),
                              'dimensions_width' => zen_db_prepare_input($_POST['products_dimensions_width']),
                              'dimensions_depth' => zen_db_prepare_input($_POST['products_dimensions_depth']),
                              'product_colour' => zen_db_prepare_input($_POST['product_colour']),
                              'product_finish' => zen_db_prepare_input($_POST['product_finish']),
                              'product_material' => zen_db_prepare_input($_POST['product_material']),
                              'product_style' => zen_db_prepare_input($_POST['product_style']),
                              'product_length' => zen_db_prepare_input($_POST['products_dimensions_length']),
                              'product_dia' => zen_db_prepare_input($_POST['product_dia']),
                              'product_min_drop' => zen_db_prepare_input($_POST['product_min_drop']),
                              'product_max_drop' => zen_db_prepare_input($_POST['product_max_drop']),
                              'product_recess' => zen_db_prepare_input($_POST['product_recess']),
                              'bulbs_included' => zen_db_prepare_input($_POST['bulbs_included']),
                              'product_shade_inc' =>  zen_db_prepare_input($_POST['product_shade_inc']),
                              'product_voltage' => zen_db_prepare_input($_POST['product_voltage']),
                              'product_transformer' => zen_db_prepare_input($_POST['product_transformer']),
                              'product_driver' => zen_db_prepare_input($_POST['product_driver']),
                              'product_guarantee' => zen_db_prepare_input($_POST['product_guarantee']),
                              'product_surface_temp' => zen_db_prepare_input($_POST['product_surface_temp']),
                              'product_cable' => zen_db_prepare_input($_POST['product_cable']),
                              'product_cut_out' => zen_db_prepare_input($_POST['product_cut_out']),
                              'product_tilt' => zen_db_prepare_input($_POST['product_tilt']),
                              'product_variant' => zen_db_prepare_input($_POST['product_variant']),
                              'product_statements' => zen_db_prepare_input($_POST['product_statements']),
                              'family_caption' => zen_db_prepare_input($_POST['family_caption']),
                              'product_carriage' => zen_db_prepare_input($_POST['product_carriage']),
                              'product_options' => zen_db_prepare_input($_POST['product_options']),
                              'rrp' => zen_db_prepare_input($_POST['product_rrp']),
                              'rate_1' => zen_db_prepare_input($_POST['product_rate_1']),
                              'rate_2' => zen_db_prepare_input($_POST['product_rate_2']),
                              'rate_3' => zen_db_prepare_input($_POST['product_rate_3']),
                              'web_price' => zen_db_prepare_input($_POST['product_web_price']),
                              'now_price' => zen_db_prepare_input($_POST['product_now_price']),
                              'bulbs_s1' => zen_db_prepare_input($_POST['product_bulbs_s1']),
                              'bulbs_s2' => zen_db_prepare_input($_POST['product_bulbs_s2'])
                              );
      ...
      zen_db_perform(TABLE_PRODUCTS_EXTRA_FIELDS, $sql_data_array);
      } elseif ($action == 'update_product') {
      zen_db_perform(TABLE_PRODUCTS_EXTRA_FIELDS, $sql_data_array, 'update', "products_id = '" . (int)$products_id . "'");
      }
      /////////////////////////////////////////////
