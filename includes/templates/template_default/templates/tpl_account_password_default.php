...
<div class="listAreaTop">
 <h1 id="accountDefaultHeading">Change Password</h1>
</div>
...
<?php echo zen_draw_password_field('password_new','','id="password-new" style="margin: 5px 0px"') . (zen_not_null(ENTRY_PASSWORD_NEW_TEXT) ? '<span class="alert">' . ENTRY_PASSWORD_NEW_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
