...
<?php } ?>
<label class="accCreateLeft" for="state" id="stateLabel"><?php echo $state_field_label; ?></label>
<?php
...
<label class="accCreateLeft" for="postcode"><?php echo ENTRY_POST_CODE; ?></label>
