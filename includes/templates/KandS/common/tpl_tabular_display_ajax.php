...
$content2 = '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="' . 'cat' . $cPath . 'Table' . 'class="tabTable">';
 ...
 $content2 .= '<' . $cell_type . $c_params . '>' . $list_box_contents[$row][$col]['text'] . '</' . $cell_type . '>'  . "\n"; ?>
<?php
      }
    }
