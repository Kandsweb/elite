 ...
 * look at: BOF: ajax :: includes the xajax && globally js scripts
 *
 ...
 * @version $Id: html_header.php 10 2007-02-01 12:44:43Z rainer $
 */
/**
...
<meta name="generator" content="Elite Lighting Online"/>
<meta name="google-site-verification" content="Dw1KAbXbIAecpg3KOdVcWMBhRBPtLnG9dE68HPQr8pk" />
<meta name="y_key" content="496c580fd734e002" />
<meta name="msvalidate.01" content="E8049BBBFBCBA974FF825853BC68AB48" />
 ...
 */
  ...
  while(list ($key, $value) = each($directory_array)) {
    ...
    if(strpos($value,'.min')===FALSE){
      ...
      //$org_file = substr($value,0,strlen($value)-3);
      $new_file = substr($value,0,strlen($value)-3) . '.min.js';
      if(file_exists($template->get_template_dir('.js',DIR_WS_TEMPLATE, $current_page_base,'jscript/min').'/'.$new_file)){
        echo '<script type="text/javascript" src="' .  $template->get_template_dir('.js',DIR_WS_TEMPLATE, $current_page_base,'jscript/min') . '/' . $new_file . '"></script>'."\n";
      }else{
