 ...
 */
 ...
 // $content .= BOX_HEADING_SEARCH;
  ...
  if (strtolower(IMAGE_USE_CSS_BUTTONS) == 'yes') {
    ...
    $content .= zen_draw_input_field('keyword', '', 'size="18" maxlength="100" style="width: ' . ($column_width-50) . 'px" value="' . HEADER_SEARCH_DEFAULT_TEXT . '" onfocus="if (this.value == \'' . HEADER_SEARCH_DEFAULT_TEXT . '\') this.value = \'\';" onblur="if (this.value == \'\') this.value = \'' . HEADER_SEARCH_DEFAULT_TEXT . '\';"') . '<br />';
    $content .= zen_image_submit('button_search.gif','Search');
    //<input type="submit" value="' . HEADER_SEARCH_BUTTON . '" style="width: 55px" />';
    $content .= '<br /><a href="' . zen_href_link(FILENAME_ADVANCED_SEARCH) . '">' . BOX_SEARCH_ADVANCED_SEARCH . '</a>';
  }
