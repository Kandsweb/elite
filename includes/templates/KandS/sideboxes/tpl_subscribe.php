 ...
 */
   ...
   $content .= zen_draw_form('subscribe', zen_href_link(FILENAME_SUBSCRIBE, '', 'SSL'), 'post', 'id="form_id" onsubmit="javascript:return emailCheck(\'form_id\',\'email1\',\'email1\');"');
   ...
   $content .= '<label>' . zen_draw_input_field('email', '', 'id="email1" size="18" maxlength="90" style="width: ' .
               ($column_width-50) . 'px" value="' . HEADER_SUBSCRIBE_DEFAULT_TEXT .
