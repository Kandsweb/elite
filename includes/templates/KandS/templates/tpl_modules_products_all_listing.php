    ...
    while (!$products_all->EOF) {
      ...
      if (PRODUCT_ALL_LIST_IMAGE != '0') {
        if ($products_all->fields['products_image'] == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == 0) {
          ...
          $products_all->fields['products_image']=get_image_xref($products_all->fields['products_image']);
...
?>
          <tr>
            <td width="<?php echo IMAGE_PRODUCT_NEW_LISTING_WIDTH + 10; ?>"  class="productListing-data" align="center" valign="middle">
              <?php
                echo family_info_tooltip($products_all->fields['products_model'],IMAGE_PRODUCT_NEW_LISTING_HEIGHT, $display_products_image);
              ?>
            </td>
            <td class="productListing-data" align="center" valign="middle">
              <?php
                ...
                echo '<br />'.product_promotion($products_all->fields['products_id'],$current_page);
              ?>
            </td>
...
<?php
      ...
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($products_all->fields['products_image'] == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == 0) {
          ...
          $display_products_image = '<a href="' . zen_href_link(zen_get_info_page($products_all->fields['products_id']), 'cPath=' . zen_get_generated_category_path_rev($products_all->fields['master_categories_id']) . '&products_id=' . $products_all->fields['products_id']) . '">' . zen_image(DIR_WS_IMAGES . $products_all->fields['products_image'], $products_all->fields['products_name'], $image_width, $image_height) . '</a><br />'.product_promotion($products_all->fields['products_id'],$current_page)
        ...
        if ($cur_col == 1){
          ...
          echo'<td class="productListing-data">' . family_info_tooltip($products_all->fields['products_model'],$hd,$display_products_image) . '</td>'; ?>
          </td>
