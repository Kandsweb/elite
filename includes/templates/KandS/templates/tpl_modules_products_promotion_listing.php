  ...
  if ($products_new_split->number_of_rows > 0) {
    ...
    while (!$products_new->EOF) {
      ...
      if (PRODUCT_NEW_LIST_MODEL != '0' and zen_get_show_product_switch($products_new->fields['products_id'], 'model')) {
        $display_products_model = 'Model:' . $products_new->fields['products_model'] . str_repeat('<br clear="all" />', substr(PRODUCT_NEW_LIST_MODEL, 3, 1));
      } else {
...
?>
          <tr>
            <td class="main" colspan="2"><?php echo NO_PROMOTION; ?></td>
          </tr>
<?php
  }
?>
