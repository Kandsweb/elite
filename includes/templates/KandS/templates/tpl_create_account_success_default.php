...
<div id="bodyWrap" style="padding: 10px 10px 10px 10px;">
<div id="createAcctSuccessMainContent" class="content">
<?php
echo ($_SESSION['customer_account_type']=='h' ? TEXT_ACCOUNT_CREATED : TEXT_ACCOUNT_CREATED_B); ?></div>
...
<!--<div class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT); ?></div>-->
<br class="clearBoth">
<?php
  }
?>
...
<div class="buttonRow forward"><?php echo '<a href="' . $origin_href . '">' . zen_image_button(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT) . '</a>'; ?></div><br>
</div>
</div>