...
<h1 id="newProductsDefaultHeading"><?php echo ($promotion_active?PROMOTION_NAME:PROMOTION); ?></h1>

<?php
/**
 * display the product order dropdown
 */
 //This is now handled by tpl_module_gallery_view.php
 ...
 */
require($template->get_template_dir('/tpl_modules_products_promotion_listing.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_products_promotion_listing.php'); ?>
