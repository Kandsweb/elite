...
<h1 id="conditionsHeading">Services</h1>
</div>
 ...
 */
  echo '<a name="design"></a>';
  require($define_page_design);

  echo '<br /><a name="delivery"></a>';
  require($define_page_delivery);

  echo '<br /><a name="installation"></a>';
  require($define_page_installation);
?>
</div>
