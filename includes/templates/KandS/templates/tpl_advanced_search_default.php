...
<br class="clearBoth" />
    <div class="centeredContent"><?php echo zen_draw_input_field('keyword', $sData['keyword'], 'onfocus="RemoveFormatString(this, \'' . KEYWORD_FORMAT_STRING . '\')"'); ?>&nbsp;&nbsp;&nbsp;<?php echo zen_draw_checkbox_field('search_in_description', '1', $sData['search_in_description'], 'id="search-in-description"'); ?><label class="checkboxLabel" for="search-in-description"><?php echo TEXT_SEARCH_IN_DESCRIPTION; ?></label>

<?php echo '<span class="searchHelp" title="Search Help|' . TEXT_SEARCH_HELP . '">'  . zen_image_button('help.gif','','width="30"') . '</span>'; ?></div>
<br class="clearBoth" />
</fieldset>
...
$(document).ready(function(){
  $('.searchHelp').cluetip({attribute: 'class', hoverClass: 'highlight', cursor:'help', splitTitle: '|', dropShadow: true, cluetipClass: 'default'});
});
//--></script>