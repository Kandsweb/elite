...
<?php
 ...
 include($template->get_template_dir('tpl_modules_index_subcats.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_index_subcats.php');
...
}elseif($_SESSION['OptionFilter']->is_filter_on()){
  echo $_SESSION['OptionFilter']->build_string();
}
?>
</div><?php // listAtreaTop ?>
