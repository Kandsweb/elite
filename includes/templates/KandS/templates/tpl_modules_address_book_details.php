...
<br class="clearBoth" />
<?php
//Add hidden field for business or personal reg so we can work out what data is required
echo zen_draw_hidden_field('account_type',$account_type, 'id="account_type"');
  ...
  if (ACCOUNT_GENDER == 'true') {
    ...
    $female = !$male;
?>
<label class="accCreateLeft" for="firstname">Salutation</label><?php echo zen_draw_radio_field('gender', 'm', $male, 'id="gender-male"') . '<label class="radioButtonLabel" for="gender-male">' . MALE . '</label>' . zen_draw_radio_field('gender', 'f', $female, 'id="gender-female"') . '<label class="radioButtonLabel" for="gender-female">' . FEMALE . '</label>' . (zen_not_null(ENTRY_GENDER_TEXT) ? '<span class="alert">' . ENTRY_GENDER_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
...
<?php
  if (ACCOUNT_COMPANY == 'true' && $_SESSION['customer_account_type']!='h') {
?>
<label class="accCreateLeft" for="company"><?php echo ENTRY_COMPANY; ?></label>
...
<label class="accCreateLeft" for="street-address"><?php echo ENTRY_STREET_ADDRESS; ?></label>
...
?>
<label class="accCreateLeft" for="suburb"><?php echo ENTRY_SUBURB; ?></label>
...
<label class="accCreateLeft" for="city"><?php echo ENTRY_CITY; ?></label>
...
<label class="accCreateLeft" for="country"><?php echo ENTRY_COUNTRY; ?></label>
...
?>
<label class="accCreateLeft" for="stateZone" id="zoneLabel"><?php echo ENTRY_STATE; ?></label>
<?php
...
<label class="accCreateLeft" id="stDiv" for="state" id="stateLabel"><?php echo $state_field_label; ?></label>
<?php
...
<label class="accCreateLeft" id="pcText" for="postcode"><?php echo ENTRY_POST_CODE; ?></label>
<?php echo zen_draw_input_field('postcode', $entry->fields['entry_postcode'], zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_postcode', '40') . ' id="postcode"') . (zen_not_null(ENTRY_POST_CODE_TEXT) ? '<span class="alert" id="pcAlert">' . ENTRY_POST_CODE_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
