...
define('FILENAME_DEFINE_COOKIE_POLICY','define_cookie_policy');
...
define('FILENAME_SERVICES_DESIGN', 'define_services_design');
define('FILENAME_SERVICES_DELIVERY', 'define_services_delivery');
define('FILENAME_SERVICES_INSTALLATION', 'define_services_installation');
