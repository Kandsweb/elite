 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  ...
                  pdex.dimensions_height, pdex.dimensions_depth, pdex.dimensions_width, pdex.bulbs_cap, pdex.bulbs_type,
                  pdex.bulbs_watts, pdex.bulbs_qty, pdex.ip_rating, pdex.manufactures_code,  pdex.web_price, pdex.rrp, pdex.rate_1,
                  pdex.rate_2, pdex.rate_3, pdex.bulbs_s1, pdex.bulbs_s2, pdex.show_price
