  ...
  if ((!isset($_SESSION['securityToken']) || !isset($_POST['securityToken'])) || ($_SESSION['securityToken'] !== $_POST['securityToken'])) {
    ...
    if (!$check_customer->RecordCount()) {
      ...
      if (!zen_validate_password($password, $check_customer->fields['customers_password'])) {
        ...
        $customers_extra = $db->Execute($sql);
        $_SESSION['customer_trade_type'] = $customers_extra->fields['customers_trade_type'];
        $_SESSION['customer_verified'] = $customers_extra->fields['customers_verified'];
        $_SESSION['customer_account_type'] = $customers_extra->fields['customers_account_type'];
        //EOE KandS
