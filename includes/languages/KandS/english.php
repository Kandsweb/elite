 ...
 */
 ...
 //KANDS START ###############
 define('PROMOTION_PREFIX', 'This item is part of our');
 define('PROMOTION_NAME', 'September Promotion');
 define('PROMOTION_POSTFIX', '');

 define('PROMOTION', 'Promotions Page'); //Uses this when on promotions
 define('NO_PROMOTION', 'There are currently no promotions. If you would like to notified when we have a promotion please sign up for our newsletter.');

 define('NEWSLETTER_SIDEBOX_HEADING', 'Newsletter');

define('INDEX_CAT_INSTRUCTION', 'Select a story from the menu on the left');
define('IMAGE_MORE_INFORMATION', 'More Information');
define('IMAGE_REDEEM', 'Redeem Coupon');
define('TEXT_NO_SPECIALS', 'We currently have no items on special offer');
define('TEXT_BROWSE_LATEST', 'Have a browse through our lastest items');
define('TEXT_SOLD_OUT_EXTRA', 'If you <a href="' . zen_href_link(FILENAME_CONTACT_US, '', 'NONSSL') . '">Contact Us</a> we will try to get you this item');
define('TEXT_CART_REMOVED', 'Sorry but the following item has just sold out and has been removed from your basket');
define('TEXT_XSELL_PRODUCTS', 'We Recommend');
define('TEXT_REDEEM_WARNING', 'Click the Redeem button above before confirming your order to apply your discount');
define('TEXT_OUTOFSTOCK_FINAL', 'An item has gone out of stock while you were with PayPal and you have been returned to your shopping basket. Your order has not been completed and you have NOT been charcged by PayPal.');
...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' Elite Lighting. Design by <a href="http://www.kandsweb.co.uk" target="_blank">KandS</a>');
...
// Define the name of your Gift Certificate as Gift Voucher, Gift Certificate, Zen Cart Dollars, etc. here for use through out the shop
  define('TEXT_GV_NAME','Gift Voucher');
  define('TEXT_GV_NAMES','Gift Vouchers');
...
// used for redeem code sidebox
  ...
  define('BOX_GV_REDEEM_INFO', 'Voucher code: ');
...
// categories box text in sideboxes/categories.php
  define('BOX_HEADING_CATEGORIES', 'Departments');
...
// whats_new box text in sideboxes/whats_new.php
  ...
  define('CATEGORIES_BOX_HEADING_WHATS_NEW', 'New Items ...');

  define('BOX_HEADING_FEATURED_PRODUCTS', 'Featured');
  define('CATEGORIES_BOX_HEADING_FEATURED_PRODUCTS', 'Featured Items ...');
  define('TEXT_NO_FEATURED_PRODUCTS', 'More featured items will be added soon. Please check back later.');

  define('TEXT_NO_ALL_PRODUCTS', 'More items will be added soon. Please check back later.');
...
// manufacturer box text
  define('BOX_HEADING_MANUFACTURER_INFO', 'Brands Info');
...
// information box text in sideboxes/more_information.php - were TUTORIAL_
  ...
  define('BOX_INFORMATION_PAGE_2', 'Size Chart');
...
// tell a friend box text in sideboxes/tell_a_friend.php
  ...
  define('BOX_TELL_A_FRIEND_TEXT', 'Tell someone you know about this item.');
...
//New billing address text
  define('SET_AS_PRIMARY' , 'Set as Default Address');
...
// javascript messages
  ...
  define('ENTRY_FIRST_NAME_ERROR', 'Is your first name correct? Our system requires a minimum of ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' characters.');
  define('ENTRY_FIRST_NAME_TEXT', '*');
  define('ENTRY_LAST_NAME', 'Last Name:');
  define('ENTRY_LAST_NAME_ERROR', 'Is your last name correct? Our system requires a minimum of ' . ENTRY_LAST_NAME_MIN_LENGTH . ' characters.');
  define('ENTRY_LAST_NAME_TEXT', '*');
  define('ENTRY_DATE_OF_BIRTH', 'Date of Birth:');
  define('ENTRY_DATE_OF_BIRTH_ERROR', 'Is your birth date correct? Our system requires the date in this format: DD/MM/YYYY (eg 19/02/2009)');
  define('ENTRY_DATE_OF_BIRTH_TEXT', '* (eg. 16/02/2007)');
  ...
  define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Our system already has a record of that email address - please try logging in with that email address. If you do not use that address any longer you can correct it in the My Account area. If you have forgotten your password you can request a new one from the log in page.');
  define('ENTRY_EMAIL_ADDRESS_TEXT', '*');
  define('ENTRY_NICK', 'Forum Nick Name:');
  define('ENTRY_NICK_TEXT', '*'); // note to display beside nickname input field
  define('ENTRY_NICK_DUPLICATE_ERROR', 'That User Name is already being used. Please try another.');
  define('ENTRY_NICK_LENGTH_ERROR', 'Please try again. Your User Name must contain at least ' . ENTRY_NICK_MIN_LENGTH . ' characters.');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> items)');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> new items)');
  define('TEXT_DISPLAY_NUMBER_OF_SPECIALS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> specials)');
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_FEATURED_PRODUCTS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> featured items)');
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_ALL', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> items)');
...
// payment method is GV/Discount
  define('PAYMENT_METHOD_GV', 'Gift Voucher/Coupon');
...
// more info in place of buy now
  define('MORE_INFO_TEXT','... read more');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added Item to the basket ...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'Successfully added selected Item(s) to the basket ...');
...
// shopping cart errors
  ...
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />We are sorry but this item has been removed from our store at this time.<br />This item has been removed from your shopping basket.');
  ...
  define('WARNING_SHOPPING_CART_COMBINED', 'NOTICE: For your convenience, your current shopping basket has been combined with your shopping basket from your last visit. Please review your shopping basket before checking out.<br />When checking out you will have to go through PayPal again, but you will ONLY be charged once.');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_FEATURED_PRODUCTS','Featured Items');
  ...
  define('SUMMARY_TABLE_UPCOMING_PRODUCTS','table contains a list of items that are due to be in stock soon and the dates the items are expected');
...
// Shipping Estimator
  define('CART_SHIPPING_OPTIONS', 'Estimate Delivery Costs');
  ...
  define('CART_SHIPPING_METHOD_TO_NOLOGIN', 'Deliver to: <a href="' . zen_href_link(FILENAME_LOGIN, '', 'SSL') . '"><span class="pseudolink">Log In</span></a>');
  define('CART_SHIPPING_METHOD_FREE_TEXT','Free Delivery');
  ...
  define('EMPTY_CART_TEXT_NO_QUOTE', 'Whoops! Your session has expired ... Please update your shopping basket for Delivery Quote ...');
  define('CART_SHIPPING_QUOTE_CRITERIA', 'Delivery quotes are based on the address information you selected:');
...
// sort order titles for dropdowns
  ...
  define('TEXT_INFO_SORT_BY_PRODUCTS_NAME', 'Item Name');
  define('TEXT_INFO_SORT_BY_PRODUCTS_NAME_DESC', 'Item Name - desc');
  define('TEXT_INFO_SORT_BY_PRODUCTS_PRICE', 'Price - low to high');
  define('TEXT_INFO_SORT_BY_PRODUCTS_PRICE_DESC', 'Price - high to low');
  define('TEXT_INFO_SORT_BY_PRODUCTS_MODEL', 'Code');
...
// create account - login shared
  ...
  define('ENTRY_EMAIL_HTML_DISPLAY','HTML (With images)');
  define('ENTRY_EMAIL_TEXT_DISPLAY','TEXT-Only');
  define('EMAIL_SEND_FAILED','ERROR: Failed sending email to: "%s" <%s> with subject: "%s"');

  define('DB_ERROR_NOT_CONNECTED', 'Error - Could not connect to Database. <b>Please Refresh this page</b>');
...
// extra product listing sorter
  ...
  define('TEXT_PRODUCTS_LISTING_ALPHA_SORTER_NAMES', 'Starting with...');
