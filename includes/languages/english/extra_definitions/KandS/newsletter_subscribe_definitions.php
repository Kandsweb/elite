...
define('SUBSCRIBE_DUPLICATE_CUSTOMERS_ERROR', 'There is already a Customer Account using that email address.<br/>To subscribe to the newsletter using this account, please <a href="index.php?main_page=account_newsletters">Login</a>');
...
define('SUBSCRIBE_DUPLICATE_NEWSONLY_ACCT', 'A Newsletter-Only subscription has been registered with this email address. You currently receive our newsletter, but do not have an account.');
...
define('SUBSCRIBE_DUPLICATE_CONFIRM_ERROR', 'This email address has already placed a Newsletter-Only subscription.<br/>If you have trouble signing up, please send a message to <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS .'</a>.');
