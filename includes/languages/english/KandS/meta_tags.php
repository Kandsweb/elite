...
// page title
define('TITLE', 'Elite Lighting &amp; Interiors');

// Site Tagline
define('SITE_TAGLINE', 'Ireland\'s largest lighting showroom');

// Custom Keywords
define('CUSTOM_KEYWORDS', ', Nothern Ireland, Ireland, Belfast, Derry, Londonderry, Mid Ulster, Antrim, Ballymena, NI, UK, IE, shop, showroom, Lighting Design, Lighting, Modern light, led light, recessed light, outdoor light, chandelier, table lamp, tiffany, floor lamp, low energy, lantern, crystal, fabric shade, lamp shade, furniture, furnishings, Dinning Table, Coffee table, recliner, Sofas, chairs, mirrors, rugs, giftware');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', '');
  define('HOME_PAGE_META_KEYWORDS', 'Dinning tables, coffee tables, Antrim, Belfast, Mid Ulster, Northern Ireland, Ireland');
