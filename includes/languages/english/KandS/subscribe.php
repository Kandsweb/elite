...
define('TEXT_INFORMATION_CONFIRM', '
  <span style="font-size:12px; color:#F00"><b>IMPORTANT</b><br/>
  ...
  <span style="font-size:12px">Please check your e-mail inbox. When you receive the confirmation request, just click on the confirmation link enclosed in the email.
   Don\'t miss out on the lastest '. STORE_NAME . ' offers - simply add '. STORE_OWNER_EMAIL_ADDRESS .' to your address book or contact list to ensure our emails always go into your inbox.
  <br />
  <br /></span>
...
define('EMAIL_CONTACT', '<br />For help with any of our online services, please email the store: <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS ." </a><br />\n\n");
